...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        if ($email_count > 0) {
            ...
            $query_usuarios = "INSERT INTO usuarios (nome, email, senha, cidade, telefone, data_nascimento) VALUES (?, ?, ?, ?, ?, ?)";
            $stmt = $mysqli->prepare($query_usuarios);
            $stmt->bind_param("ssssss", $nome, $email, $senha, $cidade, $telefone, $data_nascimento);
            $stmt->execute();
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="imgs/logo-icon.ico">
...
<body class="body-register flex-column j-content align-itens">
        ...
        <form class="form-register-principal flex-column" action="cadastro.php" method="POST">
            <div class="div-inputs flex-row j-content">
                ...
                <div class="form-group flex-column">
                    ...
                    <div class="psw flex-row">
                        ...
                        <label class="eyesenha">
                            ...
                            <svg class="eye-slash" onclick="showHide()" height="1em" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 640 512">
                                <path
                ...
                <div class="form-group flex-column">
                    ...
                    <select required name="cidade" class="cidade">
                        <option value="" disabled selected hidden>Selecione sua cidade</option>
                        <?php
                        $selected_state = $mysqli->real_escape_string($_POST['estado']);
                        $sql_code_cities = "SELECT * FROM cidades WHERE uf = 11 ORDER BY nome";
            ...
            <?php if (isset($erro_email)) {
                foreach ($erro_email as $erro_email) {
                    echo '<div class="fail-login">' . $erro_email . '</div>';
                }
            } ?>
